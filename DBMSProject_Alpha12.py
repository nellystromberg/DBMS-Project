...
def home():
    ...
    def more_info_today(): 
        ...
        if time > '09:00' and time < '19:30':
            return f"OPEN\n{date}"
            #return "OPEN\n", date
        #returns two strings fix w f string 
        elif time > '19:30' and time < '20:00':
    ...
    for thing in range(28):
        if thing == 0:
            customtkinter.CTkButton(second_open_time_frame,
                                text=f"{more_info_today}\n 09:00-20:00", 
                                font=("robot bold", 15),
                                fg_color=open_color(),
                                hover_color="#547B60",
                                width=265 ).grid(row=thing,
                                                            column=1, 
                                                            pady=5,
                                                            padx=1,
                                                            sticky="nsew"
        ...
        if thing == 6:
            customtkinter.CTkButton(second_open_time_frame,text=f"{dates(3)}\n 09:00-20:00", 
                                font=("robot bold", 15),
                                fg_color="#547B60",
                                hover_color="#547B60",
