...
search_bar.place(x=450, y=200)

#Button
search_button = customtkinter.CTkButton(labelB, 
                                        width=200, 
                                        height=50, 
                                        fg_color="white", 
                                        text="Search", 
...
search_button.place(x=650, y=300)
...
borrow_button = customtkinter.CTkButton(top_label, 
                                        width=50, 
                                        height=20, 
                                        font=specfont(30),  
                                        text="Borrow",
...
borrow_button.place(x=50,y=160)

return_button = customtkinter.CTkButton(top_label, 
                                        width=50, 
                                        height=20, 
                                        font=specfont(30), 
                                        command=returning, 
...
return_button.place(x=250,y=160)

extend_button = customtkinter.CTkButton(top_label, 
                                        width=50, 
                                        height=20, 
                                        font=specfont(30), 
                                        command=extending, 
...
extend_button.place(x=450,y=160)

customer_button = customtkinter.CTkButton(top_label, 
                                          width=50, 
                                          height=20, 
                                          font=specfont(30), 
                                          command=customers, 
...
customer_button.place(x=650,y=160)
